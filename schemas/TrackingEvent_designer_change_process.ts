...
export const TrackingEvent_designer_change_process = z
  .object({
  ...
  .strict();
export type TrackingEvent_designer_change_process = z.infer<
  typeof TrackingEvent_designer_change_process
>;
