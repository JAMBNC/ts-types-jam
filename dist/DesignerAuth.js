...
export const DesignerAuth = z.object({
    ...
    chiliAuth: z
        ...
        .strict()
        .describe("API key authentication, typically sent as a header or query parameter."),
    /**Schema definitions for various authentication methods used around the ecosystem*/
    endpointAuth: z
        .any()
        .describe("Schema definitions for various authentication methods used around the ecosystem")
        .optional(),
});
