...
const _DesignerUiLabels = z
    ...
    "menubar.logo": z
        ...
        .optional(),
    /**The icon for the text tool*/
    "tool.freeText.icon": z
        .string()
        .describe("The icon for the text tool")
        .default("format_shapes"),
    /**The label for the text tool*/
    "tool.freeText.label": z
        .string()
        .describe("The label for the text tool")
        .default("Text"),
    ...
    "workspace.toolBar.tab.returnAddress.color.label": z
        ...
        .default("Color"),
    "workspace.toolBar.tab.returnAddress.color.component": InkSelectorV1ComponentLabels.optional(),
    ...
    "workspace.toolBar.tab.mailingAddress.multipleAddress.component": VariableAddressInputV1ComponentLabels.optional(),
    ...
    "workspace.toolBar.tab.mailingAdress.color.label": z
        ...
        .describe("The return address color input label")
        .default("Color"),
    "workspace.toolBar.tab.mailingAddress.color.component": InkSelectorV1ComponentLabels.optional(),
    ...
    "adder.lamination_gloss.details": z
        ...
        .default("A protective film that adds durability and resists scratches, moisture, and everyday wear. Ideal for menus, signs, placemats, and other frequently handled prints."),
    ...
    "adder.lamination_sunscreen.details": z
        .string()
        .describe("The more details message for this adder.")
        .default("A UV-protective coating that helps prevent fading and keeps colors vibrant for longer. Best for outdoor signage, window displays, and prints exposed to sunlight."),
    ...
    "adder.lamination_soft_touch.details": z
        .string()
        .describe("The more details message for this adder.")
        .default("A premium finish with a smooth, velvety feel that creates an elegant, high-end look. Popular for business cards, presentation folders, invitations, and luxury packaging."),
    ...
    "error.SelectedColorRequiresOffsetPrinting": z
        .string()
        .describe("Error when offset color like a Pantone attempts to print digitally")
    ...
    "error.SelectedColorRequiresDigitalPrinting": z
        .string()
        .describe("Error message when a digital only custom color attempts to print offset")
