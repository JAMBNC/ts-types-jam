...
const _InventoryLevel = z
    ...
    .strict()
    .describe("An absolute stock level for one SKU. available is the sellable quantity the backend asserts; the mapper sets it as an absolute value (not a delta) at the channel's fulfillment-service location.");
...
export const InventoryLevel = _InventoryLevel;
